...
const goalsDataDutch: Goal[] = [
  {
    ...
    description: "Beter beheer van Instagram pagina en opstart van VTK Toledo pagina",
    subgoals: [
      {
        id: 1,
        title: "INSTAGRAM",
  ...
  },
  {
    ...
    description: "KULAK-studenten en internationals beter verwelkomen en ondersteunen",
    subgoals: [
      {
        id: 1,
        title: "KULAK",
  ...
  },
  {
    ...
    title: "Shiften @ VTK",
    description: "Shiften aantrekkelijker maken met een Bingo en het verbeteren van shifterswelzijn",
    subgoals: [
      {
        id: 1,
        title: "BINGO!",
  ...
  },
  {
    ...
    title: "VTFaculteit",
    description: "Inzetten op facultaire zaken zoals het 600 jarig jubileum, bachelorhervorming en startersdagen",
    subgoals: [
      {
        id: 1,
        title: "",
...
const goalsDataEnglish: Goal[] = [
  {
    ...
    description: "Better management of Instagram page and initiation of VTK Toledo page",
    subgoals: [
      {
        id: 1,
        title: "INSTAGRAM",
  ...
  },
  {
    ...
    description: "Welcoming and supporting KULAK students and internationals better.",
    subgoals: [
      {
        id: 1,
        title: "KULAK",
  ...
  },
  {
    ...
    title: "Shifts @ VTK",
    description: "Making shifts more attractive with a Bingo and improving shifter well-being.",
    subgoals: [
      {
        id: 1,
        title: "BINGO!",
  ...
  },
  {
    ...
    title: "VTFaculty",
    description: "Investing in faculty matters such as the 600th anniversary celebration, bachelor reform, and orientation days.",
    subgoals: [
      {
        id: 1,
        title: "",
