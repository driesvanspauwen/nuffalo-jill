...
export default function SinglePloeglid({ ploeglid, singlePloegLidTranslations }: { ploeglid: PloeglidEntry, singlePloegLidTranslations: any }) {
  ...
  return (
    <>
      <div className="group relative overflow-hidden rounded-md bg-white shadow-one duration-300 hover:shadow-two bg-brown-dark hover:shadow-gray-dark text-center">
