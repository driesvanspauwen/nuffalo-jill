...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-0">
          ...
          <div className="py-8">
            <div className="flex items-center justify-between">
              <p className="text-sm text-body-color dark:text-body-color-dark">
                © 2022 Nuffalo-Jil All Rights Reserved.
              </p>
              <ul className="flex items-center">
                <li>
                  <Link
                    href="/"
                    className="mr-4 text-sm text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  >
                    Privacy Policy
                  </Link>
                </li>
