                        ...
                        <div className="max-w-[470px]">
                            ...
                            <div className="mb-9">
                                ...
                                <div className="flex space-x-4">
                                    ...
                                    <a href="https://www.tiktok.com/@kiesploeg_nuffalo_jill?_t=8li8qaAYalV&_r=1" target="_blank" rel="noopener noreferrer">
                                        <svg className="w-6 h-6 text-offwhite" fill="currentColor"  viewBox="-3 -1 20 20">
                                            <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3z"/>
                                        </svg>
                                    </a>
                                    <a href="https://www.instagram.com/kiesploeg_nuffalo_jill/" target="_blank" rel="noopener noreferrer">
                                        <svg className="w-6 h-6 text-offwhite" fill="currentColor" viewBox="0 0 24 24">
